...
from offcom.logging import RENDER_LOG
from offcom.materialize import Model, Render


@hydra.main(version_base=None, config_path="../config", config_name="main")
def main(cfg: DictConfig):
    RENDER_LOG.warning(
        "The duty of `offcom.report_syn` is to produce a BASIC but executable Python script. It may not reproduce the original bug as the report may not use the original seed, input data, and output oracles. If you want to more strictly reproduce the bug, please use `offcom.model_exec`."
    )
