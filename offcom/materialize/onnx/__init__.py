...
from offcom.abstract.dtype import DTYPE_GEN_COMPLEX, DType
from offcom.abstract.op import AbsTensor
from offcom.gir import GraphIR
from offcom.macro import onnx2external_data_dir
from offcom.materialize.torch import (
    SymbolNet,
    TorchModel,
    TorchModelCPU,
    TorchModelCUDA,
...
def create_deadcode_onnx(onnx_model: onnx.ModelProto, name_mask) -> onnx.ModelProto:
    ...
    model_def = onnx.helper.make_model(
        graph=graph_def, producer_name="offcom.deadcode"
    )
