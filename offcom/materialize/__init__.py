...
from offcom.abstract.op import AbsOpBase, Constant
from offcom.abstract.tensor import AbsTensor
from offcom.error import SanityCheck
from offcom.gir import GraphIR
from offcom.util import HAS_PYGRAPHVIZ, viz_dot
...
class Model(ABC):
    ...
    def init(name, backend_target=None) -> Type["Model"]:
        ...
        if name == "torch":
            from offcom.materialize.torch import TorchModelCPU, TorchModelCUDA
            ...
            # device agnoistic
            from offcom.materialize.onnx import ONNXModelCPU, ONNXModelCUDA

            if backend_target == "gpu" or backend_target == "cuda":
                return ONNXModelCUDA
            return ONNXModelCPU
        elif name == "tensorflow":
            from offcom.materialize.tensorflow import TFModelCPU, TFModelCUDA
