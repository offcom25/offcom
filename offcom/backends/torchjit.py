...
from offcom.backends.factory import BackendCallable, BackendFactory
from offcom.materialize.torch import TorchModel, numpify
...
class TorchJIT(BackendFactory):
    ...
    def make_backend(self, model: TorchModel) -> BackendCallable:
        ...
        # add the op fusion here
        # modules_to_fuse = ['conv1', 'bn1']
        #
        # torch_net = fuse_modules(torch_net, random.choice(modules_to_fuse))
