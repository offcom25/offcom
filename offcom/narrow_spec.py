...
2. Constraint extensions are defined as Python codes. That said, we can just overload the
   operator specifactions in backend (see offcom/abstract/extension).
"""
...
from offcom import __version__
...
from offcom.gir import GraphIR, InstExpr
from offcom.logging import DTEST_LOG
from offcom.materialize import Model, TestCase

NNSMITH_CACHE_DIR = user_cache_dir(f"offcom-{__version__}")
