...
class GraphIR:
    ...
    # add the fused torch list
    torch_fuse_inst_list = []
    ...
    def concretize(self, model: ModelRef) -> None:
        ...
        for inst in self.insts:
            ...
            op.bind_node_position(inst.iexpr.op.node_position)
    ...
    def to_dot(self) -> str:
        ...
        def render_node(inst: InstIR):
            ...
            if not isinstance(inst.iexpr.op, (Input, Constant, Placeholder)):
                ...
                label += "}|"
                if inst.iexpr.op.node_position == "main":
                    extra += f"fillcolor=palegreen,style=filled,"
                elif inst.iexpr.op.node_position == "extra":
                    extra += f"fillcolor=lightyellow,style=filled,"
                else:
                    extra += f"fillcolor=darkorange,style=filled,"
